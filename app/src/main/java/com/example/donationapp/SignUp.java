...
public class SignUp extends AppCompatActivity {
    EditText fname,lname,eml,pswd,cnfrmpswd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signupbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String Emailidd = eml.getText().toString().trim();
                final String Password = pswd.getText().toString().trim();
                final String confirmpassword = cnfrmpswd.getText().toString().trim();
                                 ...
                                 public void onComplete(@NonNull Task<AuthResult> task) {
                                     ...
                                     if (task.isSuccessful()) {
                                      ...
                                      String uid=task.getResult().getUser().getUid();
                                       User info = new User(uid,Firstname,Lastname,Emailidd,Password,0);
                                        rootnode.getReference().child("NewUsers").child(uid).setValue(info);
